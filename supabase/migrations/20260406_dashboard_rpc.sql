-- ============================================================
-- DASHBOARD STATS RPC
-- Combines 4 separate stat queries into one round-trip
-- Per vestry-project.md: "Always create compound Supabase RPC functions
-- for pages with 4+ stat queries"
-- Uses tenant_id TEXT (actual DB schema)
-- ============================================================
...
BEGIN
  ...
  FROM users WHERE tenant_id = p_tenant_id AND status = 'active';
