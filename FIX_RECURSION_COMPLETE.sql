-- COMPLETE FIX FOR USERS TABLE RECURSION ISSUE
...
-- Policy 4: Super admins can read all users in their tenant
-- This uses a subquery instead of the recursive function
...
-- Policy 5: Super admins can manage users in their tenant
