-- Improved triggers for automatic member creation
-- Run this in Supabase SQL Editor to fix the triggers

-- 1. Improved user creation function with better error handling
...
-- 2. Improved member creation function
