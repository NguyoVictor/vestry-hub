-- ⚠️ IMPORTANT: Run this SQL in your Supabase SQL Editor to fix sermon reactions
-- This fixes the RLS policies so members can react to sermons in the member portal
...
-- ✅ Done! Sermon reactions, bookmarks, and notes should now work in the member portal
