...
import {
  ...
  Lock, Scale, Database, BadgeCheck, QrCode, ExternalLink, Building2, Megaphone, Quote, Image, CalendarClock, UsersRound,
} from "lucide-react";
...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Member Requests",  icon: Wrench,          path: "/settings/service-requests" },
      ...
      { label: "Appointment Types",    icon: CalendarClock, path: "/settings/appointment-types" },
      { label: "Group Types",          icon: UsersRound,    path: "/settings/group-types" },
